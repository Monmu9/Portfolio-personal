...
//Variable de todos los estileos del CSS (Styles)
const rootStyles = document.documentElement.style;

//Variable para controlar los idiomas (click en el icono del idioma)
...
const applyTranslations = (texts) => {
    ...
    Object.keys(texts).forEach((key) => {
        ...
        nodes.forEach((node) => {
            ...
            node.innerHTML = texts[key].replace(/\n/g, '<br>');
        });
    });
};


// Método para cambiar de idioma (click en banderas)
...
//Método para cambiar entre modo oscuro o claro
toggleTheme.addEventListener("click", () => {
    document.body.classList.toggle("dark");
    //Si estas en modo oscuro pasas al modo claro y viceversa, cambia el icono y el texto
...
//al final ponemos .color porque en el html le hemos llamado data-color. Si ese data-"COLOR" lo hubiemos llamado pepe, tendríamos que poner e.target.dataset.pepe
